<template>
  <div class="dashboard">
    <h1 class="subheading">This is Dashboard page</h1>
    <v-container class="my-4">
      <v-layout row class="mb-3">
        <v-tooltip top>
          <v-btn flat small color="grey" slot="activator" @click="sortBy('title')">
        ...
        <v-tooltip top>
          <v-btn flat small color="grey" slot="activator" @click="sortBy('person')">
        ...
        <v-tooltip top>
          <v-btn flat small color="grey" slot="activator" @click="sortBy('status')">
